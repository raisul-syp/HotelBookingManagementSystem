...
<div class="container-fluid">
    <div class="row page-titles mx-0">
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                <h2 class="page-header-title">{{ __('Edit Facility') }}</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">{{ __('Dashboard') }}</a></li>
                    <li class="breadcrumb-item"><a href="javascript:void(0)">{{ __('Facilities') }}</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ __('Edit Facility') }}</a></li>
                </ol>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <form action="{{ url('admin/facility/edit/'.$facility->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="tab-content tabcontent-border">
                            <div class="tab-pane fade active show" id="facility_info" role="tabpanel">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="description" name="description" rows="4" placeholder="Add Description...">{{ $facility->description }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row mb-0">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="is_active" name="is_active" {{ $facility->is_active == '1' ? 'checked':'' }}>
                                        </div>
                                    </div>
                                </div>
                            </div>
