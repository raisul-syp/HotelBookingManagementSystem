...
<div class="container-fluid">
    <div class="row page-titles mx-0">
        <div class="col-sm-6 p-md-0">
            <div class="welcome-text">
                <h2 class="page-header-title">{{ __('Edit Room Type') }}</h2>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">{{ __('Dashboard') }}</a></li>
                    <li class="breadcrumb-item"><a href="javascript:void(0)">{{ __('Room Type') }}</a></li>
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">{{ __('Edit Room Type') }}</a></li>
                </ol>
            </div>
        </div>
        <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
            <a href="{{ url('admin/roomtype') }}" class="btn btn-dark text-white">{{ __('Back To List') }}</a>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <form action="{{ url('admin/roomtype/edit/'.$roomtype->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <div class="form-title">
                            <h4>{{ __('Room Type Form') }}</h4>
                        </div>
                        <ul class="nav nav-pills">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#room_type_info">
                                    <span>
                                        <strong>
                                            <i class="ti-info"></i>
                                            <span class="ml-2">{{ __('Room Type Info') }}</span>
                                        </strong>
                                    </span>
                                </a>
                            </li>
                    ...
                    <div class="card-body">
                        <div class="tab-content tabcontent-border">
                            <div class="tab-pane fade active show" id="room_type_info" role="tabpanel">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label text-right" for="description">
                                        {{ __('Description') }}
                                    </label>
                                    <div class="col-sm-10">
                            ...
                            <div class="tab-pane fade" id="room_type_seo" role="tabpanel">
                                <div class="form-group row">
